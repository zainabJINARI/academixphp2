...
document.getElementById('btn-close-popup-create-module').addEventListener('click',()=>{
...
const tutor_course_module_lessons = document.getElementById('tutor-course-module-lessons')
